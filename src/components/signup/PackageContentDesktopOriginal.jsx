      ...
      <div className="flex flex-col h-full">
        ...
        <div className="bg-white p-7 md:px-10 md:pt-10 md:pb-8 pl-5 md:pl-10" style={{ fontFamily: SYSTEM_FONT }}>
          ...
          <div className="flex items-center">
            ...
            <div className="p-3 md:p-3 rounded-full md:rounded-lg transform transition duration-300 mr-3" style={{ background: 'linear-gradient(135deg, #162740 0%, #443660 40%, #785683 60%, #996a68 80%, #d4a574 100%)' }}>
              {option === "neuro" && (
