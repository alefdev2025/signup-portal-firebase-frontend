...
import alcorStarSelected from "/Users/nikkiolson/Development/Alcor/alcor-signup-portal/src/assets/images/alcor-star.png"; // Star for selected indicator

// Import the icons for funding options
import insuranceImage from "/Users/nikkiolson/Development/Alcor/alcor-signup-portal/src/assets/images/policy-purple.png";
import prepayImage from "/Users/nikkiolson/Development/Alcor/alcor-signup-portal/src/assets/images/bank-purple.png";
import laterImage from "/Users/nikkiolson/Development/Alcor/alcor-signup-portal/src/assets/images/decision-tree-purple.png";
...
export default function FundingPage({ initialData, onBack, onNext }) {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      // If onNext prop is provided, use it
      if (onNext) {
      ...
      <div className="w-full mx-auto px-4 sm:px-6 md:px-8 py-8" style={{ maxWidth: "90%", '@media (min-width: 768px)': { maxWidth: "70%" } }}>
        {isLoading ? (
          ...
          <div className="mb-8">
                    ...
                    <div className="bg-white px-8 py-6">
                      <div className="flex items-start mb-2">
                        ...
                        <div className="flex flex-col">
                          ...
                          {/* Popular choice tag below title */}
            ...
            {/* Dynamic detailed section based on selection */}
              ...
              <div className="py-2">
                ...
                {selectedOption === "insurance" && (
                  <div>
                    ...
                    {/* Conditional content based on insurance sub-option */}
                    <div className="pl-4">
