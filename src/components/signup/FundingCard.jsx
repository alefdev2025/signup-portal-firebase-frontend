...
// Define system font stack - matching PackageContentDesktopOriginal
  ...
  return (
    ...
    >
      ...
      <div 
        ...
        className={`rounded-3xl overflow-hidden flex flex-col ${isSelected ? "border border-[#775684]" : ""} relative bg-white h-[420px] transition-all duration-300`}>
        
        {/* Header Section - Fixed Height */}
        <div className="bg-gradient-to-br from-gray-50 to-white px-6 py-6 h-28 flex items-center">
          <div className="flex items-center w-full">
          <div className="flex-shrink-0 w-12 h-12 rounded-lg flex items-center justify-center mr-4 bg-gradient-to-br from-[#5a4e73] via-[#483d5e] to-[#362c49] border-2 border-[#A78BFA] shadow-lg">
            <img src={option.icon} alt={option.title} className="w-6 h-6 object-contain filter brightness-0 invert" />
          </div>
            <div className="flex-1 flex items-center">
              <h3 className="text-lg font-medium text-gray-800" style={{ fontFamily: SYSTEM_FONT }}>{option.title}</h3>
            </div>
          </div>
        </div>
        
        {/* Description Section - Fixed Height */}
        <div className="px-6 pb-4 h-14 flex items-center bg-white">
          <p className="text-gray-600 text-sm leading-relaxed w-full line-clamp-2 font-light" style={{ fontFamily: SYSTEM_FONT }}>
            {option.description}
          </p>
        </div>
        ...
        <div className="px-6 py-4 bg-white">
          <div className="bg-gray-100 rounded-lg px-4 py-3 border-t border-gray-200">
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-sm font-normal text-gray-500" style={{ fontFamily: SYSTEM_FONT, fontWeight: '500' }}>
                  {option.pricing.costLabel || "Typical Cost"}
                </span>
                <span className={`${option.pricing.costColor} font-normal text-base`} style={{ fontFamily: SYSTEM_FONT }}>
                  {dynamicCost}
                </span>
              </div>
              <div className="flex justify-between items-center">
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex-1 flex flex-col relative z-10 bg-white">
          <h4 className="font-normal text-sm text-gray-800 mb-3" style={{ fontFamily: SYSTEM_FONT }}>
            Benefits
          </h4>
          <ul className="space-y-3 flex-1 flex flex-col">
            {option.benefits.map((benefit, index) => (
              <li key={index} className="flex items-center">
                ...
                <span className="text-gray-700 text-sm font-light" style={{ fontFamily: SYSTEM_FONT }}>{benefit}</span>
              </li>
            ))}
          </ul>
        </div>
...
const InsuranceDetailsContent = ({
  ...
  return (
    <div style={{ fontFamily: SYSTEM_FONT }}>
      <h3 className="text-base font-normal text-[#323053] mb-3" style={{ fontFamily: SYSTEM_FONT }}>
        {option.detailsSection.title}
      </h3>
      
      {option.detailsSection.subtitle && (
        <p className="text-gray-600 text-xs mb-4 font-light" style={{ fontFamily: SYSTEM_FONT }}>
          {option.detailsSection.subtitle}
        </p>
      )}
      ...
      <div className="mb-4 relative">
        ...
        >
          <div className="flex items-center">
            ...
            <h4 className="text-xs font-normal text-gray-800" style={{ fontFamily: SYSTEM_FONT }}>
          ...
          <div className="absolute left-0 right-0 mt-1 z-20">
            ...
            >
              <div className="flex items-center">
                ...
                <h4 className="text-xs font-normal text-gray-800" style={{ fontFamily: SYSTEM_FONT }}>{option.detailsSection.subOptions.new.title}</h4>
              </div>
            </div>
            ...
            >
              <div className="flex items-center">
                ...
                <h4 className="text-xs font-normal text-gray-800" style={{ fontFamily: SYSTEM_FONT }}>{option.detailsSection.subOptions.existing.title}</h4>
              </div>
            </div>
          </div>
        )}
...
const NewPolicyContent = ({ subOption, policyResourcesExpanded, onTogglePolicyResources }) => {
  return (
    <div className="mt-3" style={{ fontFamily: SYSTEM_FONT }}>
      <h4 className="text-xs font-normal text-[#323053] mb-3 flex items-center" style={{ fontFamily: SYSTEM_FONT }}>
      ...
      <p className="text-gray-600 text-xs mb-3 font-light" style={{ fontFamily: SYSTEM_FONT }}>
        {subOption.description}
      </p>
      <div>
        <h5 className="font-normal text-black text-xs mb-2 flex items-center" style={{ fontFamily: SYSTEM_FONT }}>
          ...
          <div className="bg-[#d8b453] text-black font-normal py-0.5 px-1.5 ml-2 text-xs rounded-full" style={{ fontFamily: SYSTEM_FONT }}>
...
const ExistingPolicyContent = ({ subOption, policyDetails, validationErrors, onPolicyDetailChange, marcellusStyle }) => {
  return (
    <div className="mt-3" style={{ fontFamily: SYSTEM_FONT }}>
      <h4 className="text-xs font-normal text-[#775684] mb-3 flex items-center" style={{ fontFamily: SYSTEM_FONT }}>
        <div className="bg-[#775684] w-6 h-6 rounded-lg flex items-center justify-center mr-2">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="space-y-3">
        {subOption.form.fields.map((field) => (
          <div key={field.id} className="relative">
            <label htmlFor={field.id} className="block text-gray-700 font-normal text-xs mb-1" style={{ fontFamily: SYSTEM_FONT }}>
              {field.label}
            </label>
            {field.type === "currency" ? (
              <div className="relative">
                <span className="absolute left-2 top-1/2 transform -translate-y-1/2 text-gray-500 text-xs font-light" style={{ fontFamily: SYSTEM_FONT }}>$</span>
                <input
                  type="text"
                  id={field.id}
                  name={field.id}
                  ...
                  className={`w-full pl-6 px-2 py-1.5 text-xs border rounded-md focus:ring-1 focus:ring-[#775684] focus:border-[#775684] font-light ${
              ...
              <input
                ...
                value={policyDetails ? policyDetails[field.id] : ''}
                onChange={onPolicyDetailChange}
                className={`w-full px-2 py-1.5 text-xs border rounded-md focus:ring-1 focus:ring-[#775684] focus:border-[#775684] font-light ${
                  validationErrors && validationErrors[field.id] ? 'border-red-500 ring-1 ring-red-200' : 'border-gray-300'
                }`}
                placeholder={field.placeholder}
                style={{ fontFamily: SYSTEM_FONT }}
              ...
              <div className="absolute top-0 right-0 z-20 transform translate-x-1 -translate-y-2">
                <div className="bg-white border border-gray-200 text-gray-800 px-2 py-1 rounded shadow-lg text-xs flex items-center space-x-1">
                  <div className="bg-orange-500 text-white rounded w-3 h-3 flex items-center justify-center flex-shrink-0">
                    <span className="text-xs font-normal" style={{ fontFamily: SYSTEM_FONT }}>!</span>
                  </div>
                  <span style={{ fontFamily: SYSTEM_FONT }} className="font-light">Please fill out this field.</span>
                </div>
              </div>
            )}
          </div>
        ...
        <div className="flex items-start mt-3">
          ...
          <p className="text-gray-600 text-xs leading-relaxed font-light" style={{ fontFamily: SYSTEM_FONT }}>
  ...
  return (
    <div style={{ fontFamily: SYSTEM_FONT }}>
      ...
      <div className="bg-white p-4 rounded-lg border border-gray-200">
        <h5 className="font-normal text-black text-xs mb-3 flex items-center" style={{ fontFamily: SYSTEM_FONT }}>
          <div className="bg-[#775684] w-6 h-6 rounded-lg flex items-center justify-center mr-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <ol className="space-y-2 list-decimal list-inside text-gray-700 text-xs font-light" style={{ fontFamily: SYSTEM_FONT }}>
...
const LaterDetailsContent = ({ option }) => {
  return (
    <div style={{ fontFamily: SYSTEM_FONT }}>
      <h3 className="text-base font-normal text-[#323053] mb-4" style={{ fontFamily: SYSTEM_FONT }}>
        {option.detailsSection.title}
      </h3>
      ...
      <div className="bg-white p-4 rounded-lg border border-gray-200">
        ...
        {option.detailsSection.description && (
          <p className="text-gray-600 text-xs font-light" style={{ fontFamily: SYSTEM_FONT }}>
            {option.detailsSection.description}
          </p>
        )}
      </div>
