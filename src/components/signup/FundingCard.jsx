    ...
    >
      ...
      <div 
        ...
        <div className="bg-gradient-to-br from-gray-50 to-white px-6 py-6 h-32 flex items-center">
          <div className="flex items-center w-full">
            ...
            <div className="flex-1">
              ...
              <div className={`${option.badge.bgColor} ${option.badge.textColor} font-bold py-2 px-4 text-xs tracking-wider rounded-full inline-block shadow-sm`}>
                {option.badge.text}
              </div>
            </div>
          </div>
        ...
        <div className="px-6 pb-4 h-16 flex items-center bg-white">
          <p className="text-gray-600 text-base leading-relaxed w-full line-clamp-2 font-medium">
            {option.description}
          </p>
        </div>
        ...
        <div className="bg-gray-50 px-6 py-4 border-t border-gray-100 h-20">
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              <span className={`${option.pricing.costColor} font-bold text-lg`}>
                {dynamicCost}
              </span>
            </div>
            <div className="flex justify-between items-center">
          ...
          <ul className="space-y-3 flex-1 flex flex-col justify-center">
            {option.benefits.map((benefit, index) => (
              <li key={index} className="flex items-center">
                <img src={alcorYellowStar} alt="Benefit" className="w-5 h-5 mr-3 flex-shrink-0" />
...
const InsuranceDetailsContent = ({
  ...
  return (
    <div>
      <h3 className="text-lg font-bold text-[#323053] mb-3">
      ...
      <div className="mb-4 relative">
        ...
        >
          <div className="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#775684] mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path 
                strokeLinecap="round" 
          ...
          <div className="absolute left-0 right-0 mt-1 z-20">
            ...
            >
              <div className="flex items-center">
                ...
                <h4 className="text-sm font-semibold text-gray-800">{option.detailsSection.subOptions.new.title}</h4>
              </div>
            </div>
            ...
            >
              <div className="flex items-center">
                ...
                <h4 className="text-sm font-semibold text-gray-800">{option.detailsSection.subOptions.existing.title}</h4>
              </div>
            </div>
          </div>
        )}
...
const NewPolicyContent = ({ subOption, policyResourcesExpanded, onTogglePolicyResources }) => {
  return (
    <div className="mt-3">
      <h4 className="text-sm font-bold text-[#323053] mb-3 flex items-center">
        <div className="bg-[#775684] w-8 h-8 rounded-lg flex items-center justify-center mr-2">
      ...
      <div>
        <h5 className="font-bold text-black text-xs mb-2 flex items-center">
          <div className="bg-[#775684] w-6 h-6 rounded flex items-center justify-center mr-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
            </svg>
          </div>
          <span>{subOption.resources.title}</span>
          <div className="bg-[#d8b453] text-black font-bold py-0.5 px-1.5 ml-2 text-xs rounded-full">
        ...
        >
          <ul className="space-y-1 text-gray-600 text-xs pl-8 mb-2">
...
const ExistingPolicyContent = ({ subOption, policyDetails, validationErrors, onPolicyDetailChange, marcellusStyle }) => {
  return (
    <div className="mt-3">
      <h4 className="text-sm font-bold text-[#775684] mb-3 flex items-center">
        <div className="bg-[#775684] w-8 h-8 rounded-lg flex items-center justify-center mr-2">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="space-y-3">
        {subOption.form.fields.map((field) => (
          <div key={field.id} className="relative">
            <label htmlFor={field.id} className="block text-gray-700 font-semibold text-xs mb-1">
              {field.label}
            </label>
            {field.type === "currency" ? (
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-6 px-2 py-1.5 text-xs border rounded-md focus:ring-1 focus:ring-[#775684] focus:border-[#775684] ${
              ...
              <input
                ...
                value={policyDetails ? policyDetails[field.id] : ''}
                onChange={onPolicyDetailChange}
                className={`w-full px-2 py-1.5 text-xs border rounded-md focus:ring-1 focus:ring-[#775684] focus:border-[#775684] ${
                  validationErrors && validationErrors[field.id] ? 'border-red-500 ring-1 ring-red-200' : 'border-gray-300'
                }`}
                placeholder={field.placeholder}
                style={marcellusStyle}
        ...
        <div className="flex items-start mt-3">
          <div className="bg-[#775684] w-6 h-6 rounded flex items-center justify-center mr-2 flex-shrink-0 mt-0.5">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
          </div>
...
const LaterDetailsContent = ({ option }) => {
  return (
    <div>
      <h3 className="text-lg font-bold text-[#323053] mb-4">
        {option.detailsSection.title}
      </h3>
      ...
      <div className="bg-white p-4 rounded-lg border border-gray-200">
        <h4 className="text-sm font-bold text-[#323053] mb-3 flex items-center">
          <div className="bg-[#775684] w-8 h-8 rounded-lg flex items-center justify-center mr-2">
            <img src={whiteRoadIcon} alt="Road plan" className="h-5 w-5" />
          </div>
          The road plan
        </h4>
