...
function PaymentForm({ userData, onBack, onComplete, paymentInfo }) {
  ...
  return (
    ...
    >
      ...
      {/* Help Button - Bottom Right like MembershipPage */}
      <button
        onClick={() => setShowHelpInfo(!showHelpInfo)}
        className="fixed bottom-6 right-6 bg-[#775684] text-white rounded-full w-14 h-14 flex items-center justify-center hover:bg-[#664573] transition-all duration-300 shadow-lg hover:shadow-xl z-50"
        style={{ fontSize: '1.5rem', fontWeight: 'bold' }}
      >
        ?
      </button>

      {/* Help Panel - Narrow popup like MembershipPage */}
      {showHelpInfo && (
        <>
          {/* Overlay */}
          <div 
          ...
          {/* Help Panel */}
          <div className="fixed right-6 bottom-24 bg-white rounded-lg shadow-2xl z-50 w-80 max-h-96 overflow-hidden">
            <div className="bg-gradient-to-r from-[#775684] to-[#664573] px-4 py-3 flex justify-between items-center">
              <h3 className="text-white font-semibold text-lg">Payment Help</h3>
              <button 
                onClick={() => setShowHelpInfo(false)}
            ...
            <div className="p-4 max-h-80 overflow-y-auto text-sm space-y-3">
              <div>
                <h4 className="font-semibold text-gray-800 mb-1">Payment Security</h4>
                <p className="text-gray-600">All payments are processed securely through Stripe. Your information is encrypted and protected.</p>
              </div>
              
              <div>
                <h4 className="font-semibold text-gray-800 mb-1">ICE Discount</h4>
                <p className="text-gray-600">If you have an ICE code, your discount is applied to the first year only. Future renewals will be at the regular rate.</p>
              </div>
              
              <div>
                <h4 className="font-semibold text-gray-800 mb-1">Payment Methods</h4>
                <p className="text-gray-600">We accept Visa, Mastercard, American Express, Discover, and SEPA Direct Debit for European customers.</p>
              </div>
              
              <div>
                <h4 className="font-semibold text-gray-800 mb-1">Test Mode</h4>
                <p className="text-gray-600">Use card number 4242 4242 4242 4242 with any future expiry date and any 3-digit CVC for testing.</p>
              </div>
