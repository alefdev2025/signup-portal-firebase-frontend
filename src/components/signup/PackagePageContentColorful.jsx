        ...
        <div className="hidden md:block">
          ...
          <div className="bg-white p-4 pt-2 pl-2 sm:p-6 sm:pt-3 sm:pl-3 md:p-6 md:pt-3 md:pl-3 text-gray-800">
            <div className="flex items-center justify-between">
              ...
              <div className="p-4 md:p-6 rounded-md md:rounded-lg ml-3 flex-shrink-0 transform transition duration-300 hover:rotate-12" style={{ background: 'linear-gradient(135deg, #785683, #443660)' }}>
                {option === "neuro" && (
      ...
      <div className={`rounded-lg md:rounded-[2rem] overflow-hidden shadow-md ${selectedOption === option ? "ring-2 ring-[#775684]" : ""} transition-all duration-300 hover:shadow-lg transform hover:scale-[1.01] flex flex-col h-full`}>
        ...
        <div className="hidden md:block bg-white p-7 md:px-8 md:pt-8 md:pb-5 pl-5 md:pl-8" style={{ fontFamily: SYSTEM_FONT }}>
          ...
          <div className="flex items-center">
            ...
            <div className="p-3 md:p-3 rounded-full md:rounded-lg transform transition duration-300 hover:rotate-12 mr-3" style={{ background: 'linear-gradient(135deg, #785683, #443660)' }}>
              {option === "neuro" && (
        ...
        <div className="hidden md:block text-white pt-8 px-6 pb-8 flex-grow" style={{ fontFamily: SYSTEM_FONT, minHeight: "380px", ...planOption.gradientStyle }}>
          ...
          <p className="mt-8 pt-5 border-t border-white/30 text-gray-300 text-base font-light">
            {planOption.long}
          </p>
        </div>
      </div>
