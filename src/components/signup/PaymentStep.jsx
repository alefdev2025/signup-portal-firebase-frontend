// File: pages/signup/PaymentPage.jsx - Stripe-styled embedded payment
...
function PaymentForm({ userData, onBack, onComplete, paymentInfo }) {
  ...
  const handleStripePayment = async () => {
    ...
    try {
      ...
      // TODO: Send payment method to your backend to create PaymentIntent
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-4 sm:py-8">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-0">
            ...
            <div className="p-6 sm:p-12 lg:p-20 bg-gray-50 lg:rounded-l-lg order-2 lg:order-1">
              {/* Back Button */}
              <button 
                onClick={onBack}
            ...
            <div className="p-6 sm:p-12 lg:p-20 order-1 lg:order-2">
              <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
                {/* Contact Information */}
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-4 sm:mb-6">Contact information</h3>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2 sm:mb-3">Email</label>
                    <input
                      type="email"
                      value={userData?.contactData?.email || userData?.user?.email || ''}
                      className="w-full p-3 sm:p-4 border border-gray-300 rounded-md bg-gray-50 text-gray-600 text-sm sm:text-base"
                      readOnly
                    />
                  </div>
                </div>
                ...
                {/* Payment Method */}
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-4 sm:mb-6">Payment method</h3>
                  ...
                  <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3 mb-6 sm:mb-8">
                    <button
                      ...
                      className={`flex items-center justify-center px-4 sm:px-6 py-3 rounded-md border text-sm font-medium ${
                        paymentMethod === 'card'
                    ...
                    >
                      ...
                      <div className="ml-2 sm:ml-3 flex space-x-1">
                        <div className="w-5 h-3 sm:w-6 sm:h-4 bg-blue-600 rounded text-white text-xs flex items-center justify-center font-bold">V</div>
                        <div className="w-5 h-3 sm:w-6 sm:h-4 bg-red-500 rounded text-white text-xs flex items-center justify-center font-bold">M</div>
                        <div className="w-5 h-3 sm:w-6 sm:h-4 bg-blue-700 rounded text-white text-xs flex items-center justify-center font-bold">A</div>
                        <div className="w-5 h-3 sm:w-6 sm:h-4 bg-orange-500 rounded text-white text-xs flex items-center justify-center font-bold">D</div>
                      </div>
                    </button>
                  ...
                  {paymentMethod === 'card' && (
                    <div className="space-y-4 sm:space-y-6">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2 sm:mb-3">Card information</label>
                  ...
                  {paymentMethod === 'sepa' && (
                    <div className="space-y-4 sm:space-y-6">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2 sm:mb-3">Name</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2 sm:mb-3">IBAN</label>
                        <input
                          type="text"
                          placeholder="DE89 3704 0044 0532 0130 00"
                          className="w-full p-3 sm:p-4 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base"
                          disabled={TEST_MODE}
                        />
                      </div>
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex items-start">
                    ...
                    />
                    <label htmlFor="save-info" className="ml-3 sm:ml-4 text-sm text-gray-700">
                  ...
                  {saveInfo && (
                    <div>
                      ...
                      <div className="flex">
                        <select className="px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-l-md bg-gray-50 text-gray-600 text-sm">
                          <option>🇺🇸 +1</option>
                        </select>
                        <input
                          type="tel"
                          ...
                          className="flex-1 p-2 sm:p-3 border-t border-r border-b border-gray-300 rounded-r-md focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                        />
                        <span className="ml-2 sm:ml-3 text-sm text-gray-500 self-center">Optional</span>
                      </div>
                    </div>
                  )}
                </div>
