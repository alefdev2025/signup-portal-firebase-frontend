...
const AccountCreationForm = ({ 
  ...
  return (
    <>
      ...
      <form onSubmit={onSubmitForm} className="space-y-6 mt-8 sm:mt-0">
        ...
        <div className="mx-auto max-w-md md:max-w-none">
          ...
          <button 
            ...
            className="w-full py-3 sm:py-5 px-6 rounded-full font-semibold text-base sm:text-lg mb-2 sm:mb-10 flex items-center justify-center hover:opacity-90 disabled:opacity-70"
          >
            {isSubmitting ? (
              <>
