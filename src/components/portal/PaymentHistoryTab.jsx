  ...
  return (
    <div ref={topRef} className="payment-page -mx-6 -mt-6 md:mx-0 md:-mt-4 md:w-[95%] md:pl-4 min-h-screen" style={{ fontFamily: 'Helvetica, Arial, sans-serif' }}>
      ...
      <div className="px-4 md:px-0">
                ...
                <div key={payment.id}>
                  ...
                  <div className="sm:hidden">
                    ...
                    <div className="border-b border-gray-200 mx-2 rounded-t-lg">
                      <div className="px-2 py-2">
                        <div className="grid grid-cols-12 gap-1 text-xs text-[#6b5b7e]" style={{ fontWeight: '700' }}>
                          <div className="col-span-2 pl-1" style={{ fontWeight: '700' }}>Type</div>
                          <div className="col-span-3" style={{ fontWeight: '700' }}>Trans ID</div>
                          <div className="col-span-3" style={{ fontWeight: '700' }}>Date</div>
                          <div className="col-span-4 text-right pr-1" style={{ fontWeight: '700' }}>Amount</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="divide-y divide-gray-100 mx-2 mb-2">
                      <div className="relative px-4 py-4 hover:bg-gray-50 transition-all duration-200">
                        <div className="grid grid-cols-12 gap-1 items-center">
                          {/* Type */}
                          <div className="col-span-2">
                            <span className="text-xs text-gray-600">Signup</span>
                          </div>
                          
                          {/* Transaction ID */}
                          <div className="col-span-3">
                            <span className="font-medium text-gray-900 text-[10px]">
                              {payment.paymentIntentId ? payment.paymentIntentId.substring(0, 8) + '...' : payment.id.substring(0, 8) + '...'}
                            </span>
                          </div>
                          ...
                          <div className="col-span-4 text-right">
                            ...
                            {payment.breakdown && payment.breakdown.iceDiscount > 0 && (
                              <div className="text-[0.5rem] text-green-600">
                                ICE: -{formatCurrency(payment.breakdown.iceDiscount)}
                              </div>
                            )}
                          </div>
                        </div>
        ...
        {/* NetSuite Payment History - NOW USING THE IMPORTED COMPONENT */}
