...
const PortalSidebar = ({ activeTab, setActiveTab, profileImage, isMobileMenuOpen, setIsMobileMenuOpen, isElevated }) => {
  ...
  return (
    <>
      {/* Rounded corner masks when elevated */}
      {isElevated && (
        <>
          ...
          <div 
            ...
            style={{
              background: '#001f3f' /* Navy blue to match top gradient */
            }}
          >
            <div 
          ...
          <div 
            ...
            style={{
              background: '#252b49' /* Bottom gradient color */
            }}
          >
            <div 
      ...
      <div
        ...
        aria-label="Sidebar"
        style={{
          background: 'linear-gradient(135deg, #001f3f 0%, #252b49 100%)' /* Navy top-left to #252b49 bottom-right */
        }}
      >
        {/* Content layer */}
