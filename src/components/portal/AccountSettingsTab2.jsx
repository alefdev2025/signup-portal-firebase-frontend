...
const SettingsTab2 = () => {
  ...
  return (
    <div className="settings-tab -mx-6 -mt-6 md:mx-0 md:-mt-4 md:w-11/12 md:pl-0">
      {/* Settings Cards */}
      <div className="space-y-20 mr-auto fade-in">
        {/* Notifications Section */}
        <div className="overflow-hidden rounded-2xl slide-in mx-4 sm:mx-0" style={{ backgroundColor: 'transparent' }}>
          <div>
            <div className="px-6 py-6 sm:py-6 rounded-t-2xl sm:rounded-t-[1.25rem] banner-section" style={{ background: 'linear-gradient(90deg, #0a1628 0%, #1e2f4a 25%, #3a2f5a 60%, #6e4376 100%)' }}>
              <h2 className="text-lg sm:text-2xl font-normal text-white flex items-center drop-shadow-md">
                <Sparkles className="w-5 h-5 sm:w-7 sm:h-7 text-white drop-shadow-sm mr-3" />
                <strong className="sm:hidden text-white">Email Notifications</strong>
            ...
            <div className="bg-white rounded-b-2xl divide-y divide-gray-100">
              {/* Media Notifications */}
              <div className="p-8 sm:p-10 hover:bg-gray-50/50 transition-colors">
                ...
                {/* Extra spacing at bottom of media notifications */}
              ...
              <div className="p-8 sm:p-10 hover:bg-gray-50/50 transition-colors">
                ...
                {/* Extra spacing at bottom of staff messages */}
        ...
        {/* Security Section */}
        <div className="overflow-hidden rounded-2xl slide-in-delay-2 mb-8 sm:mb-0 mx-4 sm:mx-0" style={{ backgroundColor: 'transparent' }}>
          <div>
            <div className="px-6 py-6 sm:py-6 rounded-t-2xl sm:rounded-t-[1.25rem] banner-section" style={{ background: 'linear-gradient(90deg, #0a1628 0%, #1e2f4a 25%, #3a2f5a 60%, #6e4376 100%)' }}>
              <h2 className="text-lg sm:text-2xl font-normal text-white flex items-center drop-shadow-md">
                <Shield className="w-5 h-5 sm:w-7 sm:h-7 text-white drop-shadow-sm mr-3" />
                <strong className="sm:hidden text-white">Security</strong>
                <span className="hidden sm:inline section-title-text">Security</span>
                <img src={alcorStar} alt="" className="w-6 h-6 ml-0.5 sm:hidden" />
              </h2>
            </div>

            <div className="bg-white rounded-b-2xl p-8 sm:p-10">
              ...
              {/* Extra spacing at bottom of security section */}
      ...
      {/* Footer Actions */}
      <div className="mt-12 flex flex-col sm:flex-row items-center justify-between gap-4 p-6 bg-gradient-to-r from-gray-50 to-gray-100/70 rounded-2xl sm:rounded-2xl slide-in-delay-3 mx-4 sm:mx-0">
