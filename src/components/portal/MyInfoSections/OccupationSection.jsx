              ...
              <div className="space-y-4">
                ...
                <label className="flex items-center text-white/90">
                  <input
                    ...
                    className="w-4 h-4 rounded mr-2 bg-white/10 border border-white/20 checked:bg-purple-500 checked:border-purple-500"
                  />
                  <span className="text-sm">Have you served in the US Military?</span>
                </label>
