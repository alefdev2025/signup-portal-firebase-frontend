...
const FamilyInfoMobile = ({ 
  ...
  const getPreviewText = () => {
    ...
    const parts = [];
    if (familyInfo?.fathersName) parts.push(`Father: ${familyInfo.fathersName.split(' ')[0]}`);
    if (familyInfo?.mothersMaidenName) parts.push(`Mother: ${familyInfo.mothersMaidenName.split(' ')[0]}`);
    if (hasSpouse) parts.push(`Spouse: ${familyInfo.spousesName.split(' ')[0]}`);
              ...
              <div className="px-6 py-6">
                ...
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Information about your immediate family</p>
                  </div>
