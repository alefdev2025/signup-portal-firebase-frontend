...
const SettingsTab = () => {
  // GLOBAL STYLE SETTING - Set to true to make desktop look like mobile and wider
  const USE_MOBILE_STYLE_ON_DESKTOP = true;
  
  // SECOND VERSION SETTINGS - Set to true for wider, less rounded, no outline
  const USE_WIDER_VERSION = true;
  ...
  if (loading) {
    return (
      <div className={USE_MOBILE_STYLE_ON_DESKTOP ? "w-full -mx-10" : "-mx-6 -mt-6 md:mx-0 md:mt-0 md:w-11/12 md:pl-8"}>
  ...
  return (
    <div className={USE_MOBILE_STYLE_ON_DESKTOP ? (USE_WIDER_VERSION ? "settings-tab w-full -mx-12" : "settings-tab w-full -mx-10") : "settings-tab -mx-6 -mt-6 md:mx-0 md:-mt-4 md:w-11/12 md:pl-4"}>
      {/* Settings Cards */}
      <div className="space-y-20 mr-auto fade-in">
        {/* Notifications Section */}
        <div className={`bg-white shadow-sm ${USE_WIDER_VERSION ? '' : 'border-2 border-gray-400'} ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:border-gray-200'} ${USE_WIDER_VERSION ? 'rounded-lg' : 'rounded-[1.5rem]'} ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:rounded-[1.25rem]'} overflow-hidden slide-in mx-4 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:mx-0 sm:gradient-border'}`} style={{ boxShadow: USE_WIDER_VERSION ? '' : '4px 6px 12px rgba(0, 0, 0, 0.08)' }}>
          <div className={USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:gradient-border-inner'}>
            <div className={`px-6 py-8 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:py-7'} ${USE_WIDER_VERSION ? 'rounded-t-lg' : 'rounded-t-[1.5rem]'} ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:rounded-t-[1.25rem]'} banner-section`} style={{ background: 'linear-gradient(90deg, #0a1628 0%, #1e2f4a 25%, #3a2f5a 60%, #6e4376 100%)' }}>
              <h2 className={`text-lg ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:text-2xl'} font-normal text-white ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:text-gray-900'} flex items-center drop-shadow-md ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:drop-shadow-none'} mt-2 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:mt-0'}`}>
                <Sparkles className={`w-5 h-5 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:w-7 sm:h-7'} text-white ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:text-gray-900'} drop-shadow-sm ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:drop-shadow-none'} mr-3 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:stroke-[2]'}`} />
                <strong className={USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:hidden'}>Email Notifications</strong>
                <span className={USE_MOBILE_STYLE_ON_DESKTOP ? 'hidden' : 'hidden sm:inline section-title-text'}>Email Notifications</span>
                <img src={alcorStar} alt="" className={`w-6 h-6 ml-0.5 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:hidden'}`} />
              </h2>
            </div>

            <div className="divide-y divide-gray-100">
              {/* Media Notifications */}
              <div className={`p-6 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:p-8'} pb-8 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:pb-8'} hover:bg-gray-50/50 transition-colors`}>
                <div className={`flex items-start gap-4 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:gap-5'}`}>
                  <div className={`w-12 h-12 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:w-14 sm:h-14'} rounded-full border-2 border-gray-300 bg-white flex items-center justify-center flex-shrink-0`}>
                    <Bell className={`w-5 h-5 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:w-6 sm:h-6'} text-[#404060] stroke-[#404060]`} fill="none" strokeWidth="2" />
                  </div>
                  <div className="flex-1">
                    ...
                    <div className={`flex flex-wrap items-center gap-2 mt-4 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:hidden'}`}>
              ...
              {/* Staff Messages */}
              <div className={`p-6 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:p-8'} pb-10 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:pb-12'} hover:bg-gray-50/50 transition-colors`}>
                <div className={`flex items-start gap-4 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:gap-5'}`}>
                  <div className={`w-12 h-12 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:w-14 sm:h-14'} rounded-full border-2 border-gray-300 bg-white flex items-center justify-center flex-shrink-0`}>
                    <Mail className={`w-5 h-5 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:w-6 sm:h-6'} text-[#404060] stroke-[#404060]`} fill="none" strokeWidth="2" />
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
                      <div className="flex-1 pr-4">
        ...
        {/* Security Section */}
        <div className={`bg-white shadow-sm ${USE_WIDER_VERSION ? '' : 'border-2 border-gray-400'} ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:border-gray-200'} ${USE_WIDER_VERSION ? 'rounded-lg' : 'rounded-[1.5rem]'} ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:rounded-[1.25rem]'} overflow-hidden slide-in-delay-2 mb-8 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:mb-0'} mx-4 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:mx-0 sm:gradient-border'}`} style={{ boxShadow: USE_WIDER_VERSION ? '' : '4px 6px 12px rgba(0, 0, 0, 0.08)' }}>
          <div className={USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:gradient-border-inner'}>
            <div className={`px-6 py-8 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:py-7'} ${USE_WIDER_VERSION ? 'rounded-t-lg' : 'rounded-t-[1.5rem]'} ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:rounded-t-[1.25rem]'} banner-section`} style={{ background: 'linear-gradient(90deg, #0a1628 0%, #1e2f4a 25%, #3a2f5a 60%, #6e4376 100%)' }}>
              <h2 className={`text-lg ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:text-2xl'} font-normal text-white ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:text-gray-900'} flex items-center drop-shadow-md ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:drop-shadow-none'} mt-2 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:mt-0'}`}>
                <Shield className={`w-5 h-5 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:w-7 sm:h-7'} text-white ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:text-gray-900'} drop-shadow-sm ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:drop-shadow-none'} mr-3 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:stroke-[2]'}`} />
                <strong className={USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:hidden'}>Security</strong>
                <span className={USE_MOBILE_STYLE_ON_DESKTOP ? 'hidden' : 'hidden sm:inline section-title-text'}>Security</span>
                <img src={alcorStar} alt="" className={`w-6 h-6 ml-0.5 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:hidden'}`} />
              </h2>
            </div>

            <div className={`p-6 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:p-8'} pb-8 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:pb-8'}`}>
              <div className={`flex items-center justify-between gap-4 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:gap-6'}`}>
                <div className={`flex items-start gap-4 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:gap-5'} flex-1`}>
                  <div className={`w-12 h-12 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:w-14 sm:h-14'} rounded-full border-2 border-gray-300 bg-white flex items-center justify-center flex-shrink-0`}>
                    <Shield className={`w-5 h-5 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:w-6 sm:h-6'} text-[#404060] stroke-[#404060]`} fill="none" strokeWidth="2" />
                  </div>
                  <div className="flex-1">
                    ...
                    {!settings.twoFactorEnabled && (
                      <div className={`flex items-start gap-2 mt-4 p-3 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:p-4'} bg-gradient-to-r from-gray-50 to-gray-100/50 rounded-lg`}>
                        <AlertCircle className={`w-4 h-4 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:w-5 sm:h-5'} text-gray-800 flex-shrink-0 mt-0.5`} />
                        <p className={`text-xs ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:text-sm'} text-gray-800 font-medium`}>
                          We strongly recommend enabling two-factor authentication to protect your account
                        </p>
                      </div>
                    )}
                    <div className={`flex items-center gap-2 mt-4 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:hidden'}`}>
                      {settings.twoFactorEnabled ? (
                ...
                <div className={`flex-shrink-0 self-start mt-1 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:mt-0'}`}>
                  <CustomSwitch
      ...
      {/* Footer Actions */}
      <div className={`mt-12 flex flex-col ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:flex-row'} items-center justify-between gap-4 p-6 bg-gradient-to-r from-gray-50 to-gray-100/70 ${USE_WIDER_VERSION ? 'rounded-lg' : 'rounded-xl'} ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:rounded-2xl'} slide-in-delay-3 mx-4 ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:mx-0'}`} style={{ boxShadow: USE_WIDER_VERSION ? '' : '4px 6px 12px rgba(0, 0, 0, 0.08)' }}>
        <div className={`text-center ${USE_MOBILE_STYLE_ON_DESKTOP ? '' : 'sm:text-left'}`}>
