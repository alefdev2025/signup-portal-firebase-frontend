...
import sunsetIllustration from '../../assets/images/dewars2.jpg';
...
const OverviewTab = ({ setActiveTab }) => {
  ...
  return (
    <div className="overview-tab relative -mt-4">
      {/* Fixed background image layer */}
      <div 
        className="fixed inset-0 z-0"
        style={{
          backgroundImage: `url(${sunsetIllustration})`,
          backgroundSize: 'cover',
          backgroundPosition: 'center',
          backgroundRepeat: 'no-repeat',
          right: '-20%', // Shift image more to the right
        }}
      />
      
      {/* Gradient overlay that transitions from white to transparent */}
      <div 
      ...
      {/* Content container */}
      <div className="relative z-20 pt-6 px-6 md:px-8 lg:px-12">
        {/* Hero Banner */}
        <div 
