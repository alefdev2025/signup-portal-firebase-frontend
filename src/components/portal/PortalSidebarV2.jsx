...
const PortalSidebarV2 = ({ 
  ...
  // Portal 2 version always has rounded corners
  const sidebarClasses = `${sidebarWidth} h-full flex-shrink-0 flex flex-col 
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col h-full">
          {/* Logo section - restored original padding */}
          ...
          {/* Navigation - restored original padding */}
                ...
                <div key={item.id} className="group">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <span className={`flex-shrink-0 ${isItemActive(item.id) ? 'text-white' : 'text-white/80'}`}>
                        {item.icon}
                      </span>
                  ...
                  {/* Subitems - restored original spacing */}
          ...
          {/* Profile section - restored original padding */}
...
export default PortalSidebarV2;