...
const OverviewTab = ({ setActiveTab }) => {
  ...
  return (
    <div className="overview-tab relative -mx-6 md:-mx-8 lg:-mx-12 -mt-6">
          ...
          <div className="flex items-center justify-end gap-4">
            ...
            <div className="w-full max-w-md">
              <div className="relative">
                <input
                  type="text"
                  placeholder="Search members, documents, or resources..."
                  className="w-full px-4 py-2 pl-10 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:outline-none focus:border-white/40 focus:bg-white/20 transition-all"
                />
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="relative p-2 rounded-lg hover:bg-white/10 transition-colors group">
                <svg className="w-6 h-6 text-white/80 group-hover:text-white" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
      ...
      <div className="relative z-10 px-6 md:px-8 lg:px-12 pb-20">
        ...
        <div className="relative mb-12 animate-fadeIn pt-24">
          ...
          <div className="relative z-10">
            ...
            <div className="max-w-4xl">
              <h1 
                className="font-semibold text-white mb-4 drop-shadow-lg tracking-tight"
                style={{ 
                  fontSize: '2.5rem',
