      ...
      <div className="flex items-center gap-4">
        ...
        <div className="hidden md:block">
          <input 
            type="text" 
            placeholder="Search..." 
            className="bg-gray-100 text-gray-700 px-4 py-2 rounded-lg w-96 focus:outline-none focus:border-[#9662a2] border border-[#9662a2] placeholder-gray-500 transition-colors"
          />
        </div>
      </div>
      <div className="flex items-center gap-4">
