  ...
  return (
    <header className="bg-white px-6 py-4 border-b border-gray-200 flex items-center justify-between">
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="border-2 border-[#1a2744] text-[#1a2744] hover:bg-[#1a2744] hover:text-white px-4 py-1.5 rounded-lg font-medium text-sm transition-all">
          Quick Links
        </button>
        ...
        <button className="relative text-gray-700 hover:text-gray-900 p-2 rounded-lg hover:bg-gray-100 transition-all ml-2">
          ...
          <span className="absolute -top-1 -right-1 h-2 w-2 bg-[#9662a2] rounded-full"></span>
        </button>
