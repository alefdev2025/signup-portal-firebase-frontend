    ...
    <div className="notifications-tab -mx-6 -mt-6 md:mx-0 md:-mt-4 md:w-11/12 md:pl-0" ref={notificationsRef}>
      ...
      <div className="hidden sm:block">
        <div className="slide-in">
          ...
          <div className="overflow-hidden rounded-2xl shadow-2xl border border-gray-200" style={{ backgroundColor: 'transparent' }}>
            <div>
                    ...
                    {paginatedNotifications.map((notification, index) => (
                      <div key={notification.id} className="p-3">
                        <div
                          ...
                          className={`px-6 py-6 transition-all duration-200 cursor-pointer group rounded-lg shadow-md border ${
                            !notification.read ? 'bg-gray-100 border-gray-300' : 'bg-white border-gray-200'
                          } hover:bg-gray-50 hover:shadow-lg hover:border-gray-400`}
                        >
      ...
      <div className="sm:hidden">
        <div className="slide-in">
          {/* Main Container with Dark Banner */}
          <div className="overflow-hidden rounded-2xl mx-4 shadow-2xl border border-gray-200" style={{ backgroundColor: 'transparent' }}>
            <div>
              {/* Dark Gradient Banner */}
                  ...
                  <div className="stagger-in bg-white relative z-10">
                    {paginatedNotifications.map((notification, index) => (
                      <div key={notification.id} className="p-3">
                        <div
                          onClick={() => handleNotificationClick(notification)}
                          className={`p-6 pb-8 transition-all duration-200 cursor-pointer group rounded-lg shadow-md border ${
                            !notification.read ? 'bg-gray-100 border-gray-300' : 'bg-white border-gray-200'
                          } hover:bg-gray-50 hover:shadow-lg hover:border-gray-400`}
                        >
                          <div className="flex items-start gap-5">
...
export default NotificationsTab3;