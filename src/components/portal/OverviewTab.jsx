          ...
          <div className="flex items-center gap-12 w-full">
            ...
            <div className="flex-1">
              <h1 className="text-3xl md:text-4xl font-light text-white mb-4">
                Welcome Back{loading ? '...' : (userName ? `, ${userName}!` : '!')}
              </h1>
            ...
            {latestMediaItems[0] && (
              <div className="hidden lg:block bg-white/10 backdrop-blur-sm rounded-lg p-6 max-w-md">
                <h3 className="text-white text-lg font-medium mb-4">Latest Media</h3>
                <div className="flex items-start gap-4">
                  <img 
                    src={latestMediaItems[0].image} 
                    alt={latestMediaItems[0].title}
                    className="w-32 h-24 object-cover rounded-md shadow-lg flex-shrink-0"
                  />
                  <div>
