...
const VideoTestimonyTab2 = ({ contactId }) => {
  ...
  useEffect(() => {
    ...
    style.innerHTML = `
      .video-testimony-tab-2 * {
        font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif !important;
        font-weight: 300 !important;
      }
      .video-testimony-tab-2 .font-bold,
      .video-testimony-tab-2 .font-semibold {
        font-weight: 500 !important;
      }
      .video-testimony-tab-2 .font-bold {
        font-weight: 700 !important;
      }
      .video-testimony-tab-2 h1 {
        font-weight: 300 !important;
      }
      .video-testimony-tab-2 h2,
      .video-testimony-tab-2 h3,
      .video-testimony-tab-2 h4 {
        font-weight: 400 !important;
      }
      .video-testimony-tab-2 .font-medium {
        font-weight: 400 !important;
      }
      .video-testimony-tab-2 .fade-in {
        animation: fadeIn 0.6s ease-out;
      }
      .video-testimony-tab-2 .slide-in {
        animation: slideIn 0.6s ease-out;
      }
      .video-testimony-tab-2 .slide-in-delay-1 {
        animation: slideIn 0.6s ease-out 0.1s both;
      }
      .video-testimony-tab-2 .slide-in-delay-2 {
        animation: slideIn 0.6s ease-out 0.2s both;
      }
      .video-testimony-tab-2 .slide-in-delay-3 {
  ...
  const containerClasses = wider 
    ? "video-testimony-tab-2 w-full -mx-10 -mt-6 md:-mt-4"
    : "video-testimony-tab-2 -mx-6 -mt-6 md:mx-0 md:-mt-4 md:w-11/12 md:pl-4";
  ...
  return (
    <div className={containerClasses}>
      {/* Messages */}
      {error && (
        <div className="mb-6 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-xl mx-4 sm:mx-0">
          ...
          <div className="p-2 py-4">
            {!testimony || !testimony.data || !downloadedVideoUrl ? (
              ...
              <div className="bg-white rounded-2xl p-4 border border-gray-200" style={{ boxShadow: '4px 6px 12px rgba(0, 0, 0, 0.08)' }}>
                ...
                {!selectedVideo && !isRecording && !isPreviewing ? (
                  <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center">
                    ...
                    <div className="space-y-4">
                      {/* Upload and Record Options - Mobile Layout */}
                      <div className="flex flex-col gap-3">
                        ...
                        <label
                          ...
                          className="cursor-pointer inline-flex items-center justify-center gap-2 px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium w-full"
                        >
                          <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                          </svg>
                        ...
                        <div className="text-gray-500 font-light text-center">or</div>
                            
                        <button
                          onClick={initializeCamera}
                          className="inline-flex items-center justify-center gap-2 px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium w-full"
                        >
                          <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                          </svg>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-blue-50 rounded-xl p-4 flex flex-col gap-4">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-blue-700 font-medium text-sm">Camera preview - Ready to record</span>
                      </div>
                      <div className="flex gap-3 w-full">
                        <button
                          onClick={startRecording}
                          className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors flex items-center justify-center gap-2 text-sm font-medium flex-1"
                        >
                          <div className="w-2 h-2 bg-white rounded-full flex-shrink-0"></div>
                          Start Recording
                        </button>
                        <button
                          onClick={cancelRecording}
                          className="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium flex-1"
                        >
                          Cancel
                        </button>
                      </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-red-50 rounded-xl p-4 flex flex-col gap-4">
                      <div className="flex items-center gap-3">
                        <div className="w-3 h-3 bg-red-600 rounded-full animate-pulse flex-shrink-0"></div>
                      ...
                      <div className="flex gap-3 w-full">
                        <button
                          onClick={stopRecording}
                          className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors text-sm font-medium flex-1"
                        >
                          Stop Recording
                        </button>
                        <button
                  ...
                  <div className="space-y-6">
                    ...
                    {!uploading && !isConverting && (
                      <button
                        onClick={handleUpload}
                        className="px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors font-medium w-full"
                      >
                        Upload Video Testimony
                      </button>
                    )}
              ...
              <div className="bg-white rounded-2xl p-4 border border-gray-200" style={{ boxShadow: '4px 6px 12px rgba(0, 0, 0, 0.08)' }}>
                ...
                {/* Video Player with enhanced debugging */}
                <div className="bg-black rounded-xl overflow-hidden mb-6 w-full">
                  {downloadingVideo ? (
                    <div className="flex items-center justify-center h-64 bg-gray-900">
                      <div className="text-center">
                        <div className="w-16 h-16 relative mx-auto mb-4">
...
export default VideoTestimonyTab2;