  ...
  return (
    <div className="settings-tab -mx-6 -mt-6 md:mx-0 md:-mt-4 md:w-11/12 md:pl-4">
      ...
      <div className="space-y-20 mr-auto fade-in">
        ...
        <div className="bg-white shadow-sm border-2 border-gray-400 sm:border-gray-200 overflow-hidden slide-in mx-4 sm:mx-0 sm:gradient-border" style={{ boxShadow: '4px 6px 12px rgba(0, 0, 0, 0.08)' }}>
          <div className="sm:gradient-border-inner">
            <div className="px-6 py-8 sm:py-7 banner-section" style={{ background: 'linear-gradient(90deg, #0a1628 0%, #1e2f4a 25%, #3a2f5a 60%, #6e4376 100%)' }}>
        ...
        {/* Security Section */}
        <div className="bg-white shadow-sm border-2 border-gray-400 sm:border-gray-200 overflow-hidden slide-in-delay-2 mb-8 sm:mb-0 mx-4 sm:mx-0 sm:gradient-border" style={{ boxShadow: '4px 6px 12px rgba(0, 0, 0, 0.08)' }}>
          <div className="sm:gradient-border-inner">
            <div className="px-6 py-8 sm:py-7 banner-section" style={{ background: 'linear-gradient(90deg, #0a1628 0%, #1e2f4a 25%, #3a2f5a 60%, #6e4376 100%)' }}>
              <h2 className="text-lg sm:text-2xl font-normal text-white sm:text-gray-900 flex items-center drop-shadow-md sm:drop-shadow-none mt-2 sm:mt-0">
                ...
                <div className="flex items-start gap-4 sm:gap-5 flex-1">
                  ...
                  <div className="flex-1">
                    ...
                    {!settings.twoFactorEnabled && (
                      <div className="flex items-start gap-2 mt-4 p-3 sm:p-4 bg-gradient-to-r from-gray-50 to-gray-100/50">
