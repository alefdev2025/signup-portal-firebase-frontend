        ...
        <div className="relative z-10 min-h-screen flex flex-col">
          ...
          <div className="px-4 md:px-8 py-2">
            <div className="max-w-7xl mx-auto">
              <h2 className="text-2xl md:text-3xl font-normal text-white mb-4">Member Portal Home</h2>
              
              <div className="bg-white p-8 rounded-xl">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                {portalSections.map((section, index) => (
                  <div key={index} className="cursor-pointer group">
                    <div className="h-full relative rounded-lg min-h-[280px] overflow-hidden">
                      ...
                      <div className="absolute inset-0">
                        ...
                        <div 
                          ...
                          style={{ 
                            background: index === 0 ? 'linear-gradient(135deg, rgba(147, 116, 151, 0.85) 0%, rgba(127, 96, 131, 0.85) 50%, rgba(107, 76, 111, 0.85) 100%)' : 
                                       index === 1 ? 'linear-gradient(135deg, rgba(44, 62, 80, 0.85) 0%, rgba(52, 73, 94, 0.85) 50%, rgba(41, 57, 74, 0.85) 100%)' : 
                                       index === 2 ? 'linear-gradient(135deg, rgba(52, 73, 94, 0.85) 0%, rgba(44, 62, 80, 0.85) 50%, rgba(36, 50, 65, 0.85) 100%)' : 
                                       'linear-gradient(135deg, rgba(123, 91, 133, 0.85) 0%, rgba(103, 71, 113, 0.85) 50%, rgba(83, 51, 93, 0.85) 100%)'
                          }}
                        />
                      </div>
                      ...
                      {/* Content on white cards */}
                      <div className="relative z-10 p-px h-full flex flex-col">
                        {/* Single white card containing all content */}
                        <div className="bg-white rounded-md p-5 h-full flex flex-col" style={{boxShadow: '0 20px 50px rgba(0, 0, 0, 0.3), 0 10px 20px rgba(0, 0, 0, 0.2)'}}>
                          <div className="flex items-center gap-3 mb-4">
                            ...
                            <h3 className="text-xl font-normal text-gray-900">{section.name}</h3>
                          </div>
                          ...
                          <div className="border-t border-gray-200 pt-3">
                            <p className="text-xs text-gray-700 mb-1">{section.stats.label}</p>
