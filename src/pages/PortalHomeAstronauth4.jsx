              ...
              <div className="bg-white p-8 rounded-xl shadow-2xl">
                ...
                {portalSections.map((section, index) => (
                  <div key={index} className="cursor-pointer group">
                    <div 
                      className="h-full flex flex-col relative bg-gray-50 rounded-lg transition-all duration-300 hover:translate-y-[-2px] overflow-hidden min-h-[320px]" 
                      style={{
                    ...
                    >
                      <div className="p-6 flex flex-col h-full relative z-10">
                        <div className="absolute inset-0 bg-gradient-to-b from-gray-50 via-gray-50/75 to-gray-50/50"></div>
                        <div className="flex items-center justify-between gap-3 mb-4 relative z-10">
                          <div>
                            <h3 className="text-2xl font-semibold text-gray-900 mb-3">{section.name}</h3>
                            <div 
                        ...
                        <div className="bg-white rounded-lg border border-gray-200 p-4 relative z-10 mt-auto" style={{
                          boxShadow: '0 4px 12px rgba(0, 0, 0, 0.1), 0 2px 4px rgba(0, 0, 0, 0.06)'
                        }}>
                          <p className="text-xs text-gray-500 mb-2">{section.stats.label}</p>
