...
// ============================================
const SHOW_FLOATING_ACTION_BUTTONS = false;  // Side action buttons (help, documents, etc.)
...
const [overviewTabVersion, setOverviewTabVersion] = useState(5);
           ...
           style={{
             background: `
               radial-gradient(
                 ...
                 rgba(219, 112, 147, 0.5) 15%,
                 rgba(186, 85, 211, 0.4) 30%,
...
<div className="w-full max-w-full mx-auto mb-3 flex-shrink-0 pr-6">
 ...
 return (
   ...
   >
     ...
     {/* Conditionally render floating buttons based on global settings */}
