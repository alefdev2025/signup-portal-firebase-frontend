...
// Define help content
const methodHelpContent = [
  {
    title: "Preservation Method",
    content: "Select your preferred preservation method. Each option provides different benefits and considerations."
  },
  {
...
export default function MethodPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <ResponsiveBanner 
        activeStep={2}  // This is step 2 (Method)
        steps={steps}
        showSteps={true}
        showStar={true}
      ...
      <div className="flex-grow p-4 md:p-8 flex justify-center">
        <div className="w-full max-w-3xl">
          {/* Placeholder for Method page content */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 w-full mx-auto">
            <h2 className="text-2xl font-semibold text-gray-800 mb-6">Select Preservation Method</h2>
            <p className="text-gray-600 mb-8">
              This page will contain the method selection options. Currently a placeholder.
            </p>
