                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
                  {portalSections.map((section, index) => (
                    <div key={index} className="cursor-pointer group">
                      <div className="bg-gray-100 rounded-lg h-full flex flex-col min-h-[250px]" style={{ boxShadow: '0px 8px 14px -3px rgba(0, 0, 0, 0.15), 0px 14px 24px -5px rgba(0, 0, 0, 0.18), 0px 18px 32px -7px rgba(0, 0, 0, 0.12)' }}>
