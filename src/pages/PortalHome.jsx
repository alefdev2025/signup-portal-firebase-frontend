...
import podcastImage from '/Users/nikkiolson/Development/Alcor/alcor-signup-portal/src/assets/images/podcast.png';
import newsletterImage from '/Users/nikkiolson/Development/Alcor/alcor-signup-portal/src/assets/images/recent-newsletter.png';
  ...
  return (
    <div style={marcellusStyle} className="relative min-h-screen">
      ...
      <div 
        ...
        style={{ 
          background: 'radial-gradient(ellipse at center 40%, rgba(220, 194, 84, 0.3) 0%, rgba(185, 129, 104, 0.96) 10%, rgba(127, 96, 131, 0.96) 27.5%, rgba(85, 57, 108, 0.96) 45%, rgba(36, 44, 73, 0.95) 65%, rgba(27, 40, 66, 0.94) 82.5%, rgba(12, 24, 40, 0.95) 100%)'
        }}
      />
      ...
      <div className="relative z-10">
        ...
        <div className="min-h-screen flex flex-col">
          <div className="flex flex-col items-center justify-center px-4 md:px-8 text-center pb-2 -mt-8">
            <div className="flex items-center justify-center gap-4">
              <div>
                <h1 className="text-3xl md:text-5xl font-light text-white mb-1">
                  Member Portal
                </h1>
          ...
          <div className="px-4 md:px-8 py-2 -mt-2">
            <div className="max-w-[1280px] mx-auto">
              ...
              <div className="bg-white/95 backdrop-blur px-6 pt-6 pb-6 -mt-[1px] rounded-lg min-h-[800px] flex flex-col" style={{ 
                ...
                {activeTab === 'overview' && (
                  <>
                    <div className="mb-8">
                      <h2 className="text-3xl font-light text-gray-900">Welcome Back, Nikki!</h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 px-4">
                          ...
                          <div className="space-y-4">
                            <div className="border border-gray-200 bg-white rounded-lg p-4 hover:border-gray-300 transition-colors">
                              <div className="flex items-start gap-4">
                                <div className="w-16 h-16 rounded-2xl flex items-center justify-center flex-shrink-0 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #7F6083 0%, #936C91 100%)' }}>
                            ...
                            <div className="border border-gray-200 bg-white rounded-lg p-4 hover:border-gray-300 transition-colors">
                              <div className="flex items-start gap-4">
                                <div className="w-16 h-16 rounded-2xl flex items-center justify-center flex-shrink-0 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #36446D 0%, #4A5A8C 100%)' }}>
                                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                                  </svg>
                                </div>
                            ...
                            <div className="border border-gray-200 bg-white rounded-lg p-4 hover:border-gray-300 transition-colors">
                              <div className="flex items-start gap-4">
                                <div className="w-16 h-16 rounded-2xl flex items-center justify-center flex-shrink-0 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #55396C 0%, #6B4C85 100%)' }}>
                                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                      ...
                      {/* Middle column - Status (Progress wheel) */}
                      <div>
                        <h3 className="text-xl font-semibold text-gray-900 mb-4 text-center">Status</h3>
                        <div className="bg-gray-200 p-8">
                          <div className="bg-gray-50 p-6 text-center">
                            <div className="relative w-40 h-40 mx-auto mb-4">
                              <svg className="w-40 h-40 transform -rotate-90">
                                <defs>
                                  <linearGradient id="cryoGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                                    <stop offset="0%" stopColor="#1B2842" />
                                    <stop offset="25%" stopColor="#36446D" />
                                    <stop offset="50%" stopColor="#55396C" />
                                    <stop offset="75%" stopColor="#7F6083" />
                                    <stop offset="100%" stopColor="#B98168" />
                                  </linearGradient>
                                </defs>
                                <circle
                                  cx="80"
                            ...
                            <h3 className="text-lg font-semibold text-gray-900 mb-1">Cryopreservation</h3>
                            <p className="text-gray-600 text-sm">Sign-up Progress</p>
                            <p className="text-xs text-gray-500 mt-2">You're almost there!</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="border border-gray-200 rounded-lg overflow-hidden hover:border-gray-300 transition-colors cursor-pointer">
                            ...
                            <div className="p-4">
                              <p className="font-bold text-gray-900 text-lg">Latest Podcast</p>
                              <p className="text-gray-700 mt-2">The Future of Cryonics Technology</p>
                              <p className="text-sm text-gray-500 mt-2">Episode 47 • Dec 20, 2024</p>
                            </div>
                          </div>
                          ...
                          <div className="border border-gray-200 rounded-lg overflow-hidden hover:border-gray-300 transition-colors cursor-pointer">
                            ...
                            <div className="p-4">
                              <p className="font-bold text-gray-900 text-lg">Newsletter</p>
                              <p className="text-gray-700 mt-2">December 2024 Edition</p>
                              <p className="text-sm text-gray-500 mt-2">Research updates & member spotlights</p>
                            </div>
                          </div>
                        </div>
                      </div>
