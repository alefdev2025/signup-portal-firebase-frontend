      ...
      <div className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 min-h-screen flex flex-col">
          <div className="flex flex-col items-center justify-center px-4 md:px-8 text-center pt-20 pb-6">
            <h1 className="text-4xl md:text-5xl font-thin text-white mb-3">
              Member Portal
            </h1>
          ...
          <div className="px-4 md:px-8 py-1">
            <div className="max-w-[1280px] mx-auto">
              ...
              {/* Glassmorphic band with astronaut - shorter height */}
              <div className="relative mb-4 overflow-hidden rounded-xl backdrop-blur-md bg-white/10 border border-white/20 shadow-2xl">
                <div className="flex items-center justify-between p-4">
                  <div className="flex-1">
                    <h3 className="text-xl md:text-2xl font-light text-white mb-0.5">Welcome Back, Member</h3>
                    <p className="text-sm md:text-base text-white/80">Your journey to the future continues here</p>
                  </div>
                  
                  {/* Icon buttons in the middle */}
                  <div className="flex items-center gap-3 mx-6">
                    {/* Magazine Icon */}
                    <button className="p-2.5 rounded-lg bg-white/10 hover:bg-white/20 transition-colors duration-200">
