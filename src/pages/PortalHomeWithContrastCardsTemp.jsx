    ...
    <div style={marcellusStyle}>
      ...
      <div className="relative min-h-screen overflow-hidden">
        ...
        <div 
          ...
          style={{ background: 'radial-gradient(ellipse at center 60%, rgba(220, 194, 84, 0.85) 0%, rgba(205, 161, 94, 0.9) 5%, rgba(185, 129, 104, 0.94) 10%, rgba(156, 112, 117, 0.95) 15%, rgba(127, 96, 131, 0.96) 25%, rgba(107, 76, 111, 0.96) 40%, rgba(85, 57, 108, 0.96) 55%, rgba(60, 50, 90, 0.95) 70%, rgba(36, 44, 73, 0.95) 80%, rgba(27, 40, 66, 0.94) 90%, rgba(18, 36, 59, 0.93) 100%)' }}
        />
        ...
        <div className="relative z-10 min-h-screen flex flex-col">
          ...
          <div className="px-4 md:px-8 py-4">
            <div className="max-w-7xl mx-auto">
              <h2 className="text-2xl md:text-3xl font-normal text-white mb-6">Member Portal Home</h2>
              
              <div className="p-6 rounded-xl" style={{ background: 'linear-gradient(180deg, #d1d5db 0%, #d1d5db 40%, #e5e7eb 70%, #f9fafb 100%)' }}>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                {portalSections.map((section, index) => (
                  <div key={index} className="cursor-pointer group">
                    <div 
                      className="h-full flex flex-col relative rounded-lg" 
                      style={{
                      ...
                      onMouseEnter={(e) => { e.currentTarget.style.boxShadow = '0 8px 24px rgba(0, 0, 0, 0.16), 0 4px 8px rgba(0, 0, 0, 0.12)'; }}
                      onMouseLeave={(e) => { e.currentTarget.style.boxShadow = '0 4px 16px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.08)'; }}
                    >
                      <div className="p-5 flex flex-col h-full">
                        <div className="flex items-center gap-4 mb-3">
                          ...
                          <h3 className="text-2xl font-normal text-gray-900">{section.name}</h3>
                        </div>
                        ...
                        <div className="relative overflow-hidden rounded-lg p-3" style={{ boxShadow: '0 2px 4px rgba(0, 0, 0, 0.08), 0 1px 2px rgba(0, 0, 0, 0.06)' }}>
                          <div 
                          ...
                          <div 
                            ...
                            style={{ background: 'linear-gradient(135deg, rgba(85, 57, 108, 0.9) 0%, rgba(60, 50, 90, 0.9) 50%, rgba(36, 44, 73, 0.9) 100%)' }}
                          />
                          <div className="relative z-10">
                            <p className="text-sm text-white/90 mb-1">{section.stats.label}</p>
                            <p className="text-2xl font-bold text-white">{section.stats.value}</p>
                          </div>
                        </div>
                      </div>
                    </div>
