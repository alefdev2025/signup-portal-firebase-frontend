    ...
    <div style={marcellusStyle}>
      ...
      <div className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 min-h-screen flex flex-col">
          <div className="flex flex-col items-center justify-center px-4 md:px-8 text-center pt-20 pb-8">
                  ...
                  <div key={index} className="cursor-pointer group">
                    ...
                    >
                      <div className="p-5 flex flex-col h-full relative z-10">
                        <div className="absolute inset-0 bg-gradient-to-b from-white via-gray-50/60 to-transparent"></div>
