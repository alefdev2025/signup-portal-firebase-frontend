              ...
              <div className="bg-white p-6 rounded-xl shadow-2xl">
                ...
                {portalSections.map((section, index) => (
                  <div key={index} className="cursor-pointer group">
                    <div 
                      className="h-full flex flex-col relative bg-gray-50 rounded-lg transition-all duration-300 hover:translate-y-[-2px] overflow-hidden" 
                      style={{
                    ...
                    >
                      <div className="p-5 flex flex-col h-full relative z-10">
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed mb-4 flex-grow relative z-10">
                          {section.description}
                        </p>
                        
                        <div className="bg-white rounded-lg border border-gray-200 p-3 relative z-10" style={{
