  ...
  return (
    <div style={marcellusStyle} className="relative min-h-screen">
      <div 
        ...
        style={{ 
          background: 'radial-gradient(ellipse at center, #3d4d7e 0%, #374768 10%, #324170 20%, #2d3b62 30%, #283555 35%, #232f4a 40%, #1f2a46 45%, #1a2540 50%, #16203a 55%, #131c34 60%, #10182e 65%, #0d1428 70%, #0a1122 75%, #070d1c 80%, #050a16 85%, #030710 90%, #000000 100%)'
        }}
      />
      
      <div className="relative z-10">
        <header className="px-4 md:px-6 py-4 pt-8 flex justify-between items-center">
          <img src={alcorLogo} alt="Alcor" className="h-12 md:h-16" />
          ...
          <div className="px-4 md:px-8 -mt-8">
            <div className="max-w-[1280px] mx-auto mt-2">
                ...
                <button 
                  ...
                  className={`relative px-6 py-3 transition-all duration-200 ${
                    activeTab === 'overview' 
                      ...
                      : 'text-white hover:text-white/80 rounded-t-md mt-2'
                  }`}>
              ...
              <div className="md:hidden flex items-center justify-between mb-2">
                ...
                <span className="text-white font-medium">{activeTab.charAt(0).toUpperCase() + activeTab.slice(1)}</span>
              </div>

              {/* Mobile Menu Dropdown */}
              {mobileMenuOpen && (
                <div className="md:hidden absolute left-4 right-4 bg-white/95 backdrop-blur rounded-lg shadow-xl z-50 mb-2">
                  <button
                    onClick={() => handleTabChange('overview')}
                    className={`block w-full text-left px-4 py-3 border-b border-gray-200 ${
                      activeTab === 'overview' ? 'bg-gray-50 font-medium' : ''
                    }`}
                  >
                    Overview
                  </button>
                  <button
                    ...
                    className={`block w-full text-left px-4 py-3 border-b border-gray-200 ${
                      activeTab === 'membership' ? 'bg-gray-50 font-medium' : ''
                    }`}
                  >
                    Membership
                  </button>
                  <button
                    ...
                    className={`block w-full text-left px-4 py-3 border-b border-gray-200 ${
                      activeTab === 'documents' ? 'bg-gray-50 font-medium' : ''
                    }`}
                  >
                    Documents
                  </button>
                  ...
                  <button
                    ...
                    className={`block w-full text-left px-4 py-3 ${
                      activeTab === 'resources' ? 'bg-gray-50 font-medium' : ''
                    }`}
                  >
                    Resources
                  </button>
              ...
              <div className="bg-white/95 backdrop-blur px-6 pt-4 pb-6 -mt-[1px] rounded-lg min-h-[800px] flex flex-col md:rounded-t-none md:rounded-b-lg" style={{ 
                      ...
                      <div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="border border-gray-200 rounded-lg overflow-hidden hover:border-gray-300 transition-colors cursor-pointer">
                            ...
                            <div className="p-4">
                              <p className="font-medium text-gray-900">The Future of Cryonics Technology</p>
                          ...
                          <div className="border border-gray-200 rounded-lg overflow-hidden hover:border-gray-300 transition-colors cursor-pointer">
                            ...
                            <div className="p-4">
                              <p className="font-medium text-gray-900">Alcor Facility Tour</p>
                      ...
                      <div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="border border-gray-200 rounded-lg overflow-hidden hover:border-gray-300 transition-colors cursor-pointer">
                            ...
                            <div className="p-4">
                              <p className="font-medium text-gray-900">December 2024 Edition</p>
                          ...
                          <div className="border border-gray-200 rounded-lg overflow-hidden hover:border-gray-300 transition-colors cursor-pointer">
                            ...
                            <div className="p-4">
                              <p className="font-medium text-gray-900">Research In Motion</p>
